               ...
               if (closedDocSnap.exists()) {
                  ...
                  if (updatedStationSnap.exists()) {
                     ...
                     if (updatedStationData.ultimaActualizacion) {
                        updatedTimestamp = updatedStationData
            ...
            <View style={styles.filtersSection}>
               ...
               <View style={styles.filtersRow}>
                  ...
                  <TouchableOpacity
                     ...
                     onPress={() =>
                        selectedLinea && setShowEstacionesSheet(true)
                     }
            ...
            {stationClosed && (
               <View style={styles.alertBoxNew}>
                  ...
                  <View style={styles.alertContent}>
                     <Text style={styles.alertTitleNew}>
                        🚨 ESTACIÓN CERRADA
                     </Text>
         ...
         >
            ...
            >
               ...
               >
                  ...
                  <FlatList
                     data={
                        selectedLinea ? getStationsByLine(selectedLinea) : []
                     }
                     keyExtractor={(item) => item}
                     renderItem={({ item }) => (
                        <TouchableOpacity
